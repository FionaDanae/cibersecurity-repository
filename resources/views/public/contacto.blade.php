...
<div class="bg-gray-900 min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h2 class="text-base text-cyan-400 font-semibold tracking-wide uppercase">Contacto</h2>
        ...
        <!-- Status messages -->
        @if(session('success'))
            <div class="mb-8 bg-gray-800 border border-cyan-400 text-cyan-400 px-4 py-3 rounded relative max-w-3xl mx-auto" role="alert">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <!-- Contact form -->
                <div class="bg-gray-800 p-8 rounded-lg border border-gray-700 shadow-xl transform transition duration-500 hover:border-cyan-400">
                    ...
                    <form action="{{ route('contacto') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-white" required>
                        </div>
                        
                        <!-- Email field -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-300 mb-1">Correo electrónico</label>
                            <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-white" required>
                        </div>
                        
                        <!-- Phone field -->
                        <div>
                            <label for="telefono" class="block text-sm font-medium text-gray-300 mb-1">Teléfono (opcional)</label>
                            <input type="tel" id="telefono" name="telefono" value="{{ old('telefono') }}" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-white">
                        </div>
                        
                        <!-- Subject field -->
                        <div>
                            <label for="asunto" class="block text-sm font-medium text-gray-300 mb-1">Asunto</label>
                            <select id="asunto" name="asunto" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-white" required>
                        ...
                        <div>
                            ...
                            <textarea id="mensaje" name="mensaje" rows="5" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-white" required>{{ old('mensaje') }}</textarea>
                        </div>
                        
                        <!-- Submit button -->
                        <div class="text-center">
                            <button type="submit" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-black bg-cyan-400 hover:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-800 transition duration-300">
                                Enviar mensaje
                            </button>
                        </div>
                    </form>
                ...
                <div class="space-y-8">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <div class="inline-flex items-center justify-center h-10 w-10 rounded-md bg-gray-900 text-cyan-400">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-1 text-gray-300">info@tuempresa.com</p>
                                    <p class="mt-1 text-gray-300">soporte@tuempresa.com</p>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-800 p-8 rounded-lg border border-gray-700 shadow-xl transform transition duration-500 hover:border-cyan-400">
                        <div class="flex items-center justify-center">
                            <div class="inline-flex items-center justify-center h-12 w-12 rounded-md bg-gray-900 text-cyan-400">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-cyan-400 font-semibold">< 24 horas</p>
                            </div>
                        </div>
                    </div>
                </div>
